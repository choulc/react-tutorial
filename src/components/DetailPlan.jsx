...
const DetailPlan = () => {
    return (
        <React.Fragment>
            <section class="cases-main m_10em">
                <div class="share-box">
                    <ul class="share-itme l_float">
                        <li class="bk"><span class="share-01"></span></li>
                        <li> <span class="share-02">facebook</span></li>
                        <li> <span class="share-03">line</span></li>
                    </ul>
                    <ul class="share-itme r_float">
                        <li><span class="share-04">翰林出版</span></li>
                        <li><span class="share-05">天下雜誌</span></li>
                    </ul>
                </div>
                <h3 class="clearfix">深化在地學習之 </h3>
                <div class="intro_box">
                    <ul class="w_40">
